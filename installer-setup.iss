...
; - إمكانية تعديل نوع الإجازة
; - إرفاق صور للإجازات المرضية والمأمورية
; - تصدير النماذج كصورة PNG عالية الجودة
; - سجل تفصيلي شامل لجميع الإجازات
; - تحسينات في الأداء وتقسيم الكود
...
#define MyAppPublisher "Tameer Facility Management"
#define MyAppPublisherAR "التعمير لإدارة المرافق"
